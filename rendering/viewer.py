...
from utils.gsplat_viewer import GsplatViewer, GsplatRenderTabState
...
if __name__ == "__main__":
    ...
    CUDA_VISIBLE_DEVICES=1 python -m viewer \
        --ckpt results/6VSV7_695_v2/checkpoints_distilled/ckpt_distill_latest.pt \
        --output_dir results/6VSV7_695_v2/ \
        --port 8082
    ...
    parser.add_argument(
        "--output_dir", type=str, default="results/6VSV7_695_v2", help="where to dump outputs"
    )
    parser.add_argument(
